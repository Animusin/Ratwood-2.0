...
/datum/config_entry/flag/donations_enabled
	protection = CONFIG_ENTRY_LOCKED

/datum/config_entry/string/donation_address
	config_entry_value = "localhost"
	protection = CONFIG_ENTRY_LOCKED | CONFIG_ENTRY_HIDDEN

/datum/config_entry/number/donation_port
	config_entry_value = 3306
	min_val = 0
	max_val = 65535
	protection = CONFIG_ENTRY_LOCKED | CONFIG_ENTRY_HIDDEN

/datum/config_entry/string/donation_database
	config_entry_value = "donations"
	protection = CONFIG_ENTRY_LOCKED | CONFIG_ENTRY_HIDDEN

/datum/config_entry/string/donation_login
	config_entry_value = "root"
	protection = CONFIG_ENTRY_LOCKED | CONFIG_ENTRY_HIDDEN

/datum/config_entry/string/donation_password
	protection = CONFIG_ENTRY_LOCKED | CONFIG_ENTRY_HIDDEN
