...
/datum/outfit/job/roguetown/lich/pre_equip(mob/living/carbon/human/H) //Equipment is located below
	...
	H.adjust_skillrank_up_to(/datum/skill/misc/swimming, 1, TRUE)
	H.adjust_skillrank_up_to(/datum/skill/misc/climbing, 1, TRUE)
	...
	H.mind?.adjust_spellpoints(max(27 - H.mind.spell_points, 0))
