...
// T3: Count wealth and punish the target with diminishing returns. High wealth
// increases the lasting pressure of the miracle instead of enabling an instant kill.
